...
import carDetailes from "../../assets/cardetailes.png";
      ...
      <section>
        <div className="container my-8 md:my-10 lg:my-12">
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 items-center">
            ...
            <button className="px-4 py-2 rounded-md bg-primary text-white transition-all duration-300 ease-linear hover:bg-primary/50 font-bold text-xl mx-auto ">
              Pending
            </button>
          </div>
        </div>
